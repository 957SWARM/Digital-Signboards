...
void drawScrolltext(String scrolltextString){
  ...
  //scrolltext = "      THE RIZZLER - 2635 ~~~ IT'S NEVER AS holdupNY THE 2ND TIME AROUND - 4127";
...
if (randNumber2ElectricBoogaloo == 1){
  scrolltext = "      Can we please have Water Game 2025?";
}
...
void drawDeclarationFull (void){ // this is the best function ever.
